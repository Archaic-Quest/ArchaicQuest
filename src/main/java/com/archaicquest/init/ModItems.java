...
public class ModItems
{
    ...
    public static final RegistryObject<Item> HEART = ITEMS.register("heart", () -> new Item(new Item.Properties().group(ArchaicQuest.ARCHAIC_ITEMS)));
    public static final RegistryObject<Item> SKULL = ITEMS.register("skull", () -> new Item(new Item.Properties().group(ArchaicQuest.ARCHAIC_ITEMS)));
    public static final RegistryObject<Item> SACRIFICIAL_KNIFE = ITEMS.register("sacrificial_knife", () -> new Item(new Item.Properties().group(ArchaicQuest.ARCHAIC_ITEMS)));
    public static final RegistryObject<Item> RED_CLAY_JAR = ITEMS.register("red_clay_jar", () -> new Item(new Item.Properties().group(ArchaicQuest.ARCHAIC_ITEMS)));
